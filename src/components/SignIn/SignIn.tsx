...
import { checkExistingUsername } from "./SignInHelpers"
import { useEffect, useState } from "react"
import { LoggedInContext } from "../../App"
import { FormValues } from "../LogIn/LogIn/LogIn"
...
export const SignIn = ({hideModal}: SignInProp) => {
    ...
    return(
        <>
            ...
            {showFeedbackAlert && (
                <Alert  variant={feedbackMessage === "Username already exists!" ? 'success' : 'warning'} 
                        onClose={() => setFeedbackAlertState(false)} dismissible>
                    {feedbackMessage}
                </Alert>
            )}
        </>
